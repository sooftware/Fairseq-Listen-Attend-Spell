...
class VGGBlock(torch.nn.Module):
    """
    Wrapper class of Fairseq VGGBlock
    nn.LayerNorm => nn.BatchNorm, nn.ReLU => nn.Hardtanh(0, 20, inplace=True)
    ...
    Args:
        ...
        layer_norm: (bool) if batch norm is going to be applied. Default: False
    ...
    def __init__(
        ...
        for layer in range(num_conv_layers):
            ...
            self.layers.append(nn.Hardtanh(0, 20, inplace=True))
